void DoContour2DSterileGridRP11RP12RP13DATA_LogScale( double Dm41 = 0.01,
                                                      double dcpp = 0.0,
                                                      double d14p = 0.0,
                                                      double d24p = 0.0,
                                                      double th34p = 0.0,
  ...
  E->AddCovarianceMatrix("MRE", "inputs/MRE/MRE_ErrMatrix_20190728_r4_00.root",
                         "syst_mre", 3);
  ...
  if (inv == 1) {
    ...
    if (qdnt == 0) {
      ...
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeA-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 1) {
      S->SetSinSqTh14Range(0.25, 0.5);
      S->SetSinSqTh24Range(0, 0.25);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeB-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 2) {
      S->SetSinSqTh14Range(0.25, 0.5);
      S->SetSinSqTh24Range(0.25, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeC-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 3) {
      S->SetSinSqTh14Range(0.0, 0.25);
      S->SetSinSqTh24Range(0.25, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeD-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 4) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0, 0.5);
      S->SetSinSqTh24Range(0, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTA-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 5) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0.5, 1.0);
      S->SetSinSqTh24Range(0, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTB-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 6) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0.5, 1.0);
      S->SetSinSqTh24Range(0.5, 1.0);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTC-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 7) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0, 0.5);
      S->SetSinSqTh24Range(0.5, 1.0);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_IH_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTD-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else {
    ...
    if (qdnt == 0) {
      S->SetSinSqTh14Range(0, 0.25);
      S->SetSinSqTh24Range(0, 0.25);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeA-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 1) {
      S->SetSinSqTh14Range(0.25, 0.5);
      S->SetSinSqTh24Range(0, 0.25);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeB-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 2) {
      S->SetSinSqTh14Range(0.25, 0.5);
      S->SetSinSqTh24Range(0.25, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeC-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 3) {
      S->SetSinSqTh14Range(0.0, 0.25);
      S->SetSinSqTh24Range(0.25, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-TypeD-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 4) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0, 0.5);
      S->SetSinSqTh24Range(0, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTA-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 5) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0.5, 1.0);
      S->SetSinSqTh24Range(0, 0.5);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTB-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 6) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0.5, 1.0);
      S->SetSinSqTh24Range(0.5, 1.0);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTC-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else if (qdnt == 7) {
      cout << "Coarse Granulatity ZP5" << endl;
      S->SetSinSqTh14Range(0, 0.5);
      S->SetSinSqTh24Range(0.5, 1.0);
      fileout << "R2DSSE50S491_3FApril2020_RP11RP12RP13DATA_Dm41-" << Dm41 << "_DDD-" << dcpp << "-" << d14p << "-" << d24p << "_50x50-CGTD-T34-" << th34p << "_th13-" << th13float << "_th23-" << th23float << "_dmsq32-" << dmsq32float << ".root";
    } else {
      cout << "Learn your quads!" << endl;
      return;
    }
  ...
  S->Run2DSterileSlice_Separate_Syst_Stat_LogScale(DoCombineFit);
